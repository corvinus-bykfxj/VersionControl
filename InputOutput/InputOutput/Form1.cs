    ...
    public partial class Form1 : Form
    {
        ...
        void CreateTable()
        {
            ...
            foreach (var x in flats)
            {
                ...
                if (x.Elevator) values[counter, 4] = "Van"; else values[counter, 4] = "Nincs";
            ...
            int[] rangevalues = new int[values.Length];
            ...
            xlSheet.get_Range(
                GetCell(2, 9),
                GetCell(1 + values.GetLength(0), 9)).Value2 = "=SUM(G:G)";
        ...
        private void FormatTable()
        {
            ...
            xlSheet.get_Range(
                GetCell(2,1),
                GetCell(lastRowID, headers.Length)).BorderAround2(Excel.XlLineStyle.xlContinuous, Excel.XlBorderWeight.xlThick);
